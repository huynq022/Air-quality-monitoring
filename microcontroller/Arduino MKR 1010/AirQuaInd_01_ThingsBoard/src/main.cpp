...
char ssid[] = "Home 98";    //  your network SSID (name) 
char pass[] = "home@123";   // your network password
WiFiClient client;
...
// read the sensor values every second
    ...
    if (BME0x77_readout == 0)
    {
        ...
        else
        {
            ...
            jsonDocument["temperature"] = BME0x76_temp;
            jsonDocument["humidity"] = BME0x76_RH;
            jsonDocument["pressure"] = BME0x76_pressure;
...
// wakeup SPS30
    ...
    // delay(180000); // Wait 200 seconds to update the channel again
}
