...
//from https://github.com/terryjmyers/ADS1115-Lite/blob/master/src/ADS1115_lite.cpp
/**************************************************************************/
/*!
    @brief  Sets up the HW (reads coefficients values, etc.)
*/
/**************************************************************************/
bool Adafruit_ADS1015::testConnection() {
...
*/
/**************************************************************************/
bool Adafruit_ADS1015::isConversionDone() {
	
	Wire.beginTransmission(m_i2cAddress); //Sets the Address of the ADS1115.
	...
	Wire.requestFrom(m_i2cAddress, (uint8_t)2); //Request 2 byte config register
